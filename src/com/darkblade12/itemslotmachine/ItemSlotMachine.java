...
public final class ItemSlotMachine extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            l.warning("An error occurred while loading the settings from config.yml, plugin will disable! Cause: "
                    + e.getMessage());
    ...
    public void enableMetrics() {
        try {
            ...
            if (!metrics.isEnabled()) {
                l.warning("Metrics is disabled!");
            } else {
                l.info("This plugin is using Metrics by BtoBastian!");
            }
        } catch (Exception e) {
