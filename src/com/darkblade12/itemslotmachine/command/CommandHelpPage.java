...
public final class CommandHelpPage {
    ...
    private String insertIntoFormat(String label, ICommand i) {
        ...
        String description = plugin.messageManager.getMessage("description_" + handler.getDefaultLabel() + "_" + c.name());
        return plugin.messageManager.help_page_command_format(handler.getUsage(label, i), description, c.executableAsConsole(),
                                                              c.permission());
    }
